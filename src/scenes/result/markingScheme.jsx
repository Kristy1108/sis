...
import { faPlus, faEdit, faTrash, faRefresh, faCaretDown } from '@fortawesome/free-solid-svg-icons';
import { Button, Modal, Form } from 'react-bootstrap';
import SidebarTeacher from "../global/SidebarEmployee";
import TopbarTeacher from '../global/TopbarEmployee';
...
useEffect(() => {
  const fetchCourseTemplateCount = async () => {
    if (!selectedCourseCode) return; // Ignore if selectedCourseCode is empty

    try {
      const response = await axios.get(`${employeeLocalhost}/marking/getCourseTemplateCount/${selectedCourseCode}`);
...
const handleSubmit = async (e) => {
    ...
    const totalDays  = Number(mark1) + Number(mark2) + Number(mark3) + Number(mark4) + Number(mark5);
    ...
    try {
        ...
        Swal.fire({
            ...
            setSelectedTotalWrittenTest(null);
            setSelectedTotalOralTest(null);
            setSelectedTotalAssignment(null);
            setSelectedTotalResearch(null);
    ...
    <div>
        ...
        <div className='manageCourseBoxDiv'>
            <div className="manageCourseContainer">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <Form.Select name="exam4" value={selectedExam4} onChange={handleSelectChange}>
                                        <option value="">Select Exam</option>
                                        <option value="DIT">Written Test</option>
                                        <option value="DIP">Oral Test</option>
                                        <option value="DSE">Homework</option>
                                        <option value="DSG">Project</option>
                                    </Form.Select>
                                    </Form.Group>
                                </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <Form.Select name="exam5" value={selectedExam5} onChange={handleSelectChange}>
                                        ...
                                        <option value="Oral Test">Oral Test</option>
                                        <option value="Homework">Homework</option>
                                        <option value="Project">Group Discussion</option>
                                    </Form.Select>
                                    </Form.Group>
                                </div>
                ...
                dialogClassName="custom-modal">
                    <Modal.Header closeButton>
                        <Modal.Title style={{ color: '#151632' }}>Edit Marking Scheme</Modal.Title>
                    </Modal.Header>
                    <Modal.Body className="custom-modal-body">
                    <Form>
                    ...
                    <Modal.Footer style={{ position: 'sticky', bottom: 0, background: 'white', zIndex: 999 }}>
                        <Button type='submit' variant="primary" style={{ width: '100%' }} onClick={handleEditSubmit}>Update</Button>
                    </Modal.Footer>
                </Modal>
            </div>
        </div>
