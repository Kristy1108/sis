...
import "../student/managestudent.css";
import 'bootstrap/dist/css/bootstrap.min.css';
import 'bootstrap-icons/font/bootstrap-icons.css';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faArrowLeft, faEye, faClipboardList, faDownload } from '@fortawesome/free-solid-svg-icons';
...
import { programModules } from '../student/programModules';
import { programNameMapping } from '../student/programNameMapping';
...
export default function StudentTranscript() {
  ...
  const loadData = async () => {
    try {
      const response = await axios.get(`${studentLocalhost}/student/getStudentIDInfo/${Cookies.get("studentStdID")}`);
  ...
  function renderHeader(doc, studentName, stuidentNRIC, studentID, studentProg, studentCredit, page) {
    // Header Section
    ...
    doc.text(`Date of completion             :   `, 132, 46);
    ...
    if (studentProg === "DIT") {
        ...
        programText = "Professional Diploma in Software Engineer";
    } else if (studentProg === "DSG") {
        programText = "Professional Degree in Software Engineer";
    }
        ...
        for (let i = 1; i <= numTables; i++) {
          ...
          transcriptData
            ...
            .forEach((transcriptRow) => {
              ...
              const isSpecialCourse = ["HD221", "NS221", "DS211", "NS121", "AW421", "AW221", "MD221", "WD222", "RD211", "WF211", "WD211", "SS411"].includes(transcriptRow.examCourseCode);
          ...
          <table className="styled-table" style={{width: '100%'}}>
            <thead>
              <tr>
                ...
                <th style={{ textAlign: "center" }}>Student New ID</th>
                    ...
                    {enrollData.length > 0 ? (
                      enrollData.map((info, index) => (
                        <tr key={index}>
                          ...
                          <td>{semesterTeacherMap[info.classEnrollDateProgCode] || "Loading..."}</td>
                        </tr>
                      ))
                    ) : (
                      <tr>
